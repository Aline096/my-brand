...
class SingleBlog extends React.Component {
    ...
    componentDidMount() {
    fetch(`https://mybrand-api-uwera.herokuapp.com/api/articles/${id}`)
    .then(res => res.json())
    .then(
    (result) => {
    this.setState({
        ...
        return (
            <div>
                ...
                <div class="likes-and-comment-count">
                    <button  id="like-btn" class="btns"><i class="far fa-heart" ></i> </button><small class="count btns" id="likes"> ${article.likes}</small> 
                    <button  id="comment-btn" class="btns"><i class="far fa-comment" ></i> </button><small class="count btns" id="comments" >${article.comments.length} </small>      
                </div>
                ...
                <div class="comments-container center_display">
